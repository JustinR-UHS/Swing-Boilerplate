...
public class Hotdog {
    ...
    public static final String[] AVAILABLE_TOPPINGS = {"Chili","Hamburger buns", "Uncooked onions", "Onions", "Cheese", "Ketchup", "Mustard", "Mayonnaise"};
