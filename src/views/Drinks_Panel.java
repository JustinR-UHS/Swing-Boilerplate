...
public final class Drinks_Panel extends JPanel {
    ...
    public Drinks_Panel(Drinks_Controller controller) {
        super();
    ...
    private JPanel createNewOrderPanel(Drinks_Controller controller) {
    ...
    private JPanel createFormPanel(Drinks_Controller controller) {
    ...
    private JPanel createToppingsPanel(Drinks_Controller controller) {
        JPanel toppingsPanel = new JPanel(new GridLayout(3, 3, 10, 10));

        String[] availableToppings = Drinks.AVAILABLE_TOPPINGS;
    ...
    private JPanel createButtonPanel(Drinks_Controller controller) {
