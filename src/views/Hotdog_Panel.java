...
public final class Hotdog_Panel extends JPanel {
    ...
    public Hotdog_Panel(Hotdog_Controller controller) {
        super();
    ...
    private JPanel createNewOrderPanel(Hotdog_Controller controller) {
    ...
    private JPanel createFormPanel(Hotdog_Controller controller) {
    ...
    private JPanel createToppingsPanel(Hotdog_Controller controller) {
    ...
    private JPanel createButtonPanel(Hotdog_Controller controller) {
